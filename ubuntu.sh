...
wget http://ubuntu-cdimages.mirror.liquidtelecom.com/ubuntu-base/releases/hirsute/beta/ubuntu-base-${UBUNTU_VERSION}-beta-base-${ARCHITECTURE}.tar.gz -q -O ubuntu.tar.gz
