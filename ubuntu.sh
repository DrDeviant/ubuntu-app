...
wget http://mirror.math.princeton.edu/pub/ubuntu-archive/releases/ubuntu-base/releases/disco/release/ubuntu-base-${UBUNTU_VERSION}-base-${ARCHITECTURE}.tar.gz -q -O ubuntu.tar.gz
...
printf "\x1b[38;5;214m[${time1}]\e[0m \x1b[38;5;127m[QUESTION]:\e[0m \x1b[38;5;87m Do you want to install ubuntu-app? [Y/n] "
